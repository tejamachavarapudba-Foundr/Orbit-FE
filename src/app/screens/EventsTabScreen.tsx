          ...
          <Card className="mt-6">
            <CardContent className="items-center gap-3 px-6 py-12">
              ...
              <AppText tone="muted" size="sm" className="text-center leading-5">
                Join meetups, see who is attending, and host your own events. This module will connect when the events
                API is available on your backend.
              </AppText>
            </CardContent>
          </Card>
        </View>
